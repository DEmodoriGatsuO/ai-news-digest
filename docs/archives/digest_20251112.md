---
layout: default
title: AI最新ニュースダイジェスト 2025年11月12日
---

# AI最新ニュースダイジェスト
**更新日時: 2025年11月12日 12:59**

## 1. Analysing Environmental Efficiency in AI for X-Ray Diagnosis
...
## 2. Beyond Correctness: Confidence-Aware Reward Modeling for Enhancing Large Language Model Reasoning
...
## 3. Procedural Knowledge Improves Agentic LLM Workflows
...
## 4. Think Before You Retrieve: Learning Test-Time Adaptive Search with Small Language Models
...
## 5. Beyond Fact Retrieval: Episodic Memory for RAG with Generative Semantic Workspaces
...
## 6. AI-Driven Contribution Evaluation and Conflict Resolution: A Framework & Design for Group Workload Investigation
...
## 7. Making LLMs Reliable When It Matters Most: A Five-Layer Architecture for High-Stakes Decisions
...
## 8. AIA Forecaster: Technical Report
...
## 10. Towards AI-Assisted Generation of Military Training Scenarios

**ソース**: cs.AI updates on arXiv.org  
**日付**: 2025年11月12日  
**リンク**: [https://arxiv.org/abs/2511.07690](https://arxiv.org/abs/2511.07690)  
